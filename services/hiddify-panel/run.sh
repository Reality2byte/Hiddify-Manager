...
source /opt/hiddify-manager/services/redis/redis_utils.sh
activate_python_venv

ensure_hiddify_data_dirs
mkdir -p "$HIDDIFY_DATA/hiddify-panel"

PANEL_DIR="/opt/hiddify-manager/services/hiddify-panel"
APP_CFG="$HIDDIFY_DATA/hiddify-panel/app.cfg"
...
export HIDDIFY_CFG_PATH="$APP_CFG"
